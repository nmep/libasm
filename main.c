...
int	main(int ac, char **av)
{
	...
	// bytes_ft_read = ft_read(0, buff1, 7);
	// printf("ft_read = [%s] | bytes read = %d\n", buff1, bytes_ft_read);
	// bytes_read = read(0, buff2, 7);
	...
	t_list	*new2 = ft_lst_new(&num2);
	t_list	*new3 = ft_lst_new(&num3);
	t_list	*new4 = ft_lst_new(&num4);
